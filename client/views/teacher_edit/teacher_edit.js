...
Template.teacherEdit.helpers({
  info: function() {  //add dismiss button and record state in user profile
    ...
    if (TEstate == 'accordion') return 'Just click and start writing to edit text. &nbsp;&nbsp;&nbsp;&nbsp;Click outside edited area to save changes.  &nbsp;&nbsp;&nbsp;&nbsp;Use the Esc key to cancel. &nbsp;&nbsp;&nbsp;&nbsp;Drag items within any list to reorder.';
